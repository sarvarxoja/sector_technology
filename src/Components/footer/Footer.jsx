      ...
      <div className="footer-background">
        <div className="container footer-links">
          ...
          <div>
            <h4>Наш адрес</h4>
            <li>
              <a href="https://www.google.ru/maps/place/SECTOR+TECHNOLOGY+LTD/@41.282665,69.2015527,17z/data=!3m1!4b1!4m6!3m5!1s0x38ae8ba8fe15b771:0x26de3eab18f004c0!8m2!3d41.282661!4d69.2041276!16s%2Fg%2F11y3127ct0?entry=ttu" className="text-white phone-link">
                <i className="fas fa-map-marker-alt icon-fl text-white"></i>: Tashkent 
              </a>
            </li>
          </div>
          <div>
            <h4>О компании</h4>
            <li>
              <Link to={"/about/campany"} className="footer-li size">
                Просмотр данных
              </Link>
            </li>
          </div>
